$(document).ready(function () {
    ...
    var myCalendar = createCalendar({
        ...
        data: {
            // Event title
            title: "Andrea and María's Wedding",

            // Event start date
            start: new Date('May 3, 2025 11:30'),
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        if (MD5($('#invite_code').val()) !== 'e4da3b7fbbce2345d7772b0674a318d5'
            && MD5($('#invite_code').val()) !== 'e4da3b7fbbce2345d7772b0674a318d5') {
            $('#alert-wrapper').html(alert_markup('danger', '<strong>Sorry!</strong> Your invite code is incorrect.'));
        } else {
            $.post('https://script.google.com/macros/s/AKfycbxyl5z35_EL8nqR0BRBTvh3JGKHPcZw_8Lkyr8Adv7sEugb4GBw9iZfsDsYD5KYiIFHZA/exec', data)
                .done(function (data) {
                    console.log(data);
